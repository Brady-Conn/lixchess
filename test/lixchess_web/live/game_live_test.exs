defmodule LixchessWeb.GameLiveTest do
  use LixchessWeb.ConnCase

  import Phoenix.LiveViewTest
  import Lixchess.GamesFixtures

  @create_attrs %{fenstring: "some fenstring"}
  ...
  describe "Index" do
    ...
    test "updates game in listing", %{conn: conn, game: game} do
      ...
      assert html =~ "some updated fenstring"
    end
